  ...
  return Card(
    ...
    child: SizedBox(
      ...
      child: TextField(
        ...
        onSubmitted: (value) {
          if (navigateOnSubmit && value.isNotEmpty) {
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: isSearchIcon
              ? Padding(
                  padding: const EdgeInsets.only(left: 10), // Padding izquierdo de 10
          ...
          border: OutlineInputBorder(
            borderSide: BorderSide(
              color: isShadow == false ? AppColors.tfBorder : Colors.transparent,
            ),
            borderRadius: BorderRadius.circular(borderRadius.r),
          ),
        ),
