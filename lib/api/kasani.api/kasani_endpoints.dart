class KasaniEndpoints {
  ...
  //--------------Categories--------------
  static const String categoriesSubcategories =
      '$apiServer/producto/categoria/consultar';
  //--------------------------------------
  ...
  static const String orderHistoryDetail =
      '$apiServer/prepedido/consultar_detalle';
  //--------------------------------------
