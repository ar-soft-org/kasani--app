...
class AppColors {
  static const lightCyan = Color(0xFF009EBF);
  ...
  static const sand = Color(0XFF828282);
  static const whiteShade = Color(0XFFF1F1F1);
  static const lightGrey = Color(0XFFCCBEBE);

  static const calenderLable = Color(0XFFB5BEC6);
  static const blackShade = Color(0XFF1B1B1B);
  static const purple = Color(0XFF9586A8);
